...
function RestaurantDetailPage({ restaurantId }: Props) {
    ...
    <div>
      ...
      <main className="bg-white p-20">
        ...
        <div className="mt-20 flex h-[44px] gap-10">
          <RestaurantAddInterestButton liked={restaurant.liked} restaurantId={Number(restaurantId)} />
        ...
        <section>
          <div className="mt-24 flex items-center justify-between">
            ...
            {reviewCount > 3 && (
              <Link href={`/reviews?restaurantId=${restaurantId}`} type="button" className="flex items-center">
